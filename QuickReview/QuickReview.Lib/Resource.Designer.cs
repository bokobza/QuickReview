...
namespace QuickReview.Lib {
    ...
    internal class Resource {
        ...
        /// <summary>
        ///   Looks up a localized string similar to {0}/UI/Pages/Scc/Difference.aspx?opath={1}&amp;ocs={2}&amp;mpath={3}&amp;mss={4}%3B{5}&amp;pguid={6}.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to {0}/UI/Pages/Scc/ViewShelveset.aspx?shelveset={1}%3B{2}&amp;pguid={3}.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to {0}/UI/Pages/Scc/ViewSource.aspx?path={1}&amp;ss={2}%3B{3}&amp;pguid={4}.
        /// </summary>
